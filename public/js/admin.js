      ...
      $.get(ruta, function (data) {
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
              ...
              fila += "<td><a href='#modal-editar-actividad' data-toggle='modal' class='btn third-color m-r-20' data-id='" + data[i].id + "' data-nombre='" + data[i].nombre + "' data-monto='" + data[i].monto + "'><i class='zmdi zmdi-edit'></i></a></td>";
              fila += "</tr>";
      ...
      $.get(ruta, function (data) {
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
              ...
              fila += "<td>" + data[i].monto + "</td>";
              fila += "<td><a href='#modal-editar-matricula' data-toggle='modal' class='btn third-color m-r-20' data-id='" + data[i].id + "' data-nombre='" + data[i].nombre + "' data-monto='" + data[i].monto + "'><i class='zmdi zmdi-edit'></i></a><label class='checkbox checkbox-inline'><input type='checkbox'><i class='input-helper'></i>Seleccionar</label></td>";
              fila += "</tr>";
      ...
      if (!errors) {
        ...
        if (anio_inicio == anio_fin) {
          for (var nro_mes = nro_mes_inicio; nro_mes <= nro_mes_fin; nro_mes++) {
            ...
            var fecha_fin = moment(fecha_inicio, 'YYYY/M/DD').endOf('month').format('YYYY/MM/DD');
          ...
          debug('El año de inicio es menor al año de fin.');
          var m_fecha_inicio = moment(anio_inicio + "/" + nro_mes_inicio + "/01", 'YYYY/M/DD');
          var m_fecha_fin = moment(anio_fin + "/" + nro_mes_fin + "/01", 'YYYY/M/DD');

          while (m_fecha_inicio <= m_fecha_fin) {
            var nombre = 'Pension ' + m_fecha_inicio.format('MMMM') + ' ' + m_fecha_inicio.format('YYYY');
            var pension_ini = m_fecha_inicio.format('YYYY/MM/DD');
            var pension_fin = m_fecha_inicio.clone().endOf('month').format('YYYY/MM/DD');
      ...
      $.get(ruta, function (data) {
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
              ...
              fila += "<td>" + data[i].nombre + "</td>";
              fila += "<td>" + data[i].monto + "</td>";
              fila += "<td><a href='#modal-editar-pension' data-toggle='modal' class='btn third-color m-r-20' data-id='" + data[i].id + "' data-monto='" + data[i].monto + "'><i class='zmdi zmdi-edit'></i> Editar</a></td>";
              fila += "</tr>";
    ...
    $.get(ruta, function (data) {
      if (data.length > 0) {
        for (var i = 0; i < data.length; i++) {
            ...
            fila += "<td>" + data[i].nombre + "</td>";
            fila += "<td>" + data[i].monto + "</td>";
            fila += "<td><a href='#modal-editar-pension' data-toggle='modal' class='btn third-color m-r-20' data-id='" + data[i].id + "' data-monto='" + data[i].monto + "'><i class='zmdi zmdi-edit'></i></a></td>";
            fila += "</tr>";
            $('#tabla-listar-pensiones tbody').append(fila);
        };
      } else {
      ...
      $.get(ruta, function (data) {
        if (data.length > 0) {
          for (var i = 0; i < data.length; i++) {
              ...
              fila += "<td><a href='#modal-editar-c-ordinario' data-toggle='modal' class='btn third-color m-r-20' ";
    ...
    $.get(ruta, function (data) {
      if (data.length > 0) {
        for (var i = 0; i < data.length; i++) {
            ...
            fila += "<td><a href='#modal-editar-c-ordinario' data-toggle='modal' class='btn third-color m-r-20' ";
            fila += "data-id='" + data[i].id + "' data-nombre='" + data[i].nombre + "' data-monto='" + data[i].monto + "' data-estado='" + data[i].estado + "'><i class='zmdi zmdi-edit'></i></a></td>";
            fila += "</tr>";
            $('#tabla-lista-c-ordinarios tbody').append(fila);
        };
      } else {
