  ...
  $.get(ruta, function (data) {
    if (data.length > 0) {
      for (var i = 0; i < data.length; i++) {
        ...
        fila += "<td><a href='#modal-editar-rubro' data-toggle='modal' class='btn third-color' data-id=" + data[i].id + " data-nombre="+ data[i].nombre +"><i class='zmdi zmdi-edit'></i></a>";
        fila += "<a class='btn fourth-color waves-effect eliminar-rubro' data-toggle='tooltip' data-placement='top' data-original-title='Eliminar'><i class='zmdi zmdi-delete'></i></a></td>";
        fila += "</tr>";
