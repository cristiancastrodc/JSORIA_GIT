...
Route::get('admin/cobro/otro/listar/{id_institucion?}', 'OtrosCobrosController@listaCobros');
...
Route::get('admin/retiro/resumen/{id_retiro}', 'RetirosController@show');
# Reportes
...
Route::get('tesorera/egreso/{id_egreso}/resumen/{proceso?}', 'EgresosController@show');
# Reportes
