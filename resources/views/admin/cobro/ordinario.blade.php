...
@section('content')
  ...
  <div class="row" ng-app="cobrosOrdinarios" ng-controller="crearCobroOrdinarioController">
    <div class="col-md-6">
        ...
        <div class="card-body card-padding">
          <form class="form-horizontal">
            ...
            <div class="form-group m-t-15">
              ...
              <div class="col-sm-5">
                <button type="button" class="btn btn-block waves-effect  accent-color" ng-click="guardarCobroOrdinario()" ng-disabled="procesando || !esValidoFormCreacion()">
    ...
    <div class="col-md-6">
      <div class="card hoverable">
        ...
        <div class="card-body card-padding">
          <form class="form-horizontal" id="form-lista-c-ordinarios">
            <div class="form-group">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group">
                <label for="modal_unitario" class="col-sm-3 control-label">Monto Unitario:</label>
                <div class="col-sm-9">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modal_unitario" ng-model="modal.con_factor">
                      <i class="input-helper"></i>
                      Convertir en Monto Unitario
                      <p><small> El monto Unitario permite agregar la cantidad a multiplicar para obtener el monto total</small></p>
                    </label>
              ...
              <div class="form-group">
                <label for="modal_estado" class="col-sm-3 control-label">Habilitado:</label>
                <div class="col-sm-9">
                  <div class="toggle-switch">
                    <label for="modal_estado" class="ts-label"></label>
                    <input id="modal_estado" ng-model="modal.estado" type="checkbox" hidden="hidden">
                    <label for="modal_estado" class="ts-helper"></label>
                  </div>
                </div>
              </div>
            </form>
