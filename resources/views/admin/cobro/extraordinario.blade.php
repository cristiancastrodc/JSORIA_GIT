...
@section('content')
  ...
  <div class="row" ng-app="cobrosExtraordinarios" ng-controller="crearCobroExtraordinarioController">
    <div class="col-md-6">
        ...
        <div class="card-body card-padding">
          <form class="form-horizontal">
              ...
              <div class="col-sm-9">
                <div class="fg-line">
                  <div class="select">
                    ...
                    <input type="hidden" value="{@ form_busqueda.institucion @}" id="id_institucion_listar">
                  </div>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <button type="button" class="btn btn-block accent-color waves-effect" id="btn-listar-extraordinarios">Buscar</button>
              </div>
            </div>
          </form>
        </div>
