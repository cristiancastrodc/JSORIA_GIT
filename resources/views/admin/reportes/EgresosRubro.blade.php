    ...
    <div class="col-md-8">
      <div class="card hoverable">
        ...
        <div class="card-body card-padding">
          <form action="{{ url('/admin/reportes/EgresosRubro/procesar') }}" class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              <div class="col-sm-3 col-sm-offset-9">
                <button type="submit" class="btn btn-block waves-effect m-t-15 accent-color" id="btn-reporte-EgresosRubro" formtarget="_blank">Generar</button>
              </div>
            </div>            
          </form>
        </div>
