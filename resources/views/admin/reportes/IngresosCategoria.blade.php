...
@section('content')
  <h1>REPORTE DE INGRESOS AGRUPADOS POR CATEGORIA</h1>
         ...
         {!!Form::open(array('class' => 'form-horizontal', 'id' => 'form-reporte-ingresos','route' => 'admin.reportes.IngresosTotales.procesar.store','method' => 'POST'))!!}          
            ...
            <div class="form-group">
              <div class="pull-right">
                <button type="submit" class="btn btn-warning waves-effect" id="btn-reporte-IngresosCategoria">Generar</button>
              </div>
            </div>
          {!!Form::close()!!}
        </div>
