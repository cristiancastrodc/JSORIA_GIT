      ...
      <div class="col-md-12">
        <div class="card hoverable">
          ...
          <div class="card-body card-padding">
            <form action="{{ url('/admin/reportes/cuenta_alumno/procesar') }}" class="form-horizontal" method="POST" id="cuenta_alumno">
              ...
              <div ng-show="hayAlumno">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="fg-line">
                      <div class="select">
                        <select id="categoria" class="form-control" ng-options="categoria.periodo for categoria in categorias" ng-model="categoria">
