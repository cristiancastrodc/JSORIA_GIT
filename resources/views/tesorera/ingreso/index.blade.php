              ...
              <table class="table table-bordered table-condensed" id="tabla-ingresos-cajera">
                <thead>
                  <tr>
                    ...
                    <th class="main-color c-white">Fecha</th>
                    <th class="main-color c-white">Comprobante</th>
                    <th class="main-color c-white">Concepto</th>
                    <th class="main-color c-white x2">Estado</th>
                    <th class="main-color c-white">Monto</th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group">
                <div class="col-md-4 col-md-offset-8">
                  <a class="btn btn-link btn-block" data-dismiss="modal">Cerrar</a>
                </div>
              </div>
            </form>
          </div>
