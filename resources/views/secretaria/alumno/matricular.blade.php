              ...
              <div ng-show="matriculando">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="fg-line">
                      <div class="select">
                        <select name="detalle_institucion" id="detalle_institucion" class="form-control" ng-options="division.nombre_division for division in detalle" ng-model="detalle_institucion" ng-change="cargarGradosYMatriculas()">
                ...
                <div class="form-group">
                  <label for="grado" class="control-label col-sm-3">{@ label_grado @}</label>
                  <div class="col-sm-9">
                    <div class="fg-line">
                      <div class="select">
                        <select name="grado" id="grado" class="form-control" ng-options="grado.nombre_grado for grado in grados" ng-model="grado">
                          <option value="">Seleccione {@ label_grado @}</option>
                        </select>
                      </div>
                    </div>
                  </div>
